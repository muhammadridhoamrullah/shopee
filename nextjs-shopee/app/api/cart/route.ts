import { schemaAddToCart } from "@/src/helpers/zod";
...
export async function POST(request: NextRequest) {
  try {
    ...
    const validationSchema = schemaAddToCart.safeParse(body);
    ...
    await addToCart(userId, validationSchema.data.productId, validationSchema.data.quantity);
