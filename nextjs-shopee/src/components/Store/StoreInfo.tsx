...
import { LuUserRoundCheck, LuUsers } from "react-icons/lu";
import { MdOutlineStarOutline } from "react-icons/md";
import StoreMenuBar from "./StoreMenuBar";
import { StoreResponse } from "@/src/type/store";
import { formatLastLogin } from "@/src/utils/Store/Store";
...
export default function StoreInfo({ data, totalProducts }: Props) {
  console.log(totalProducts, "tot gweh");
              ...
              <div className=" w-full h-full flex justify-between items-center gap-2">
                ...
                <div className=" flex-1 h-full pt-2 flex flex-col gap-0.5 justify-start items-start">
                  ...
                  <p className="text-xs text-gray-300">
                    Aktif {formatLastLogin(data.lastLogin)}
                  </p>
        ...
        <div className=" flex-1 h-full px-4 py-6 flex justify-between items-center text-sm">
          ...
          <div className="flex-1 h-full flex flex-col justify-between items-start">
            ...
            <div className="flex items-center gap-2">
              ...
              {/* Awal Text Produk */}
              <span>
                Produk: <span className="text-[#EE4D2D]">{totalProducts}</span>
              </span>
              {/* Akhir Text Produk */}
            </div>
            {/* Akhir Produk */}
          ...
          <div className=" flex-1 h-full flex flex-col justify-between items-start">
            ...
            <div className="flex items-center gap-2">
              ...
              {/* Awal Text Bergabung */}
              <span>
                Bergabung: <span className="text-[#EE4D2D]">30 Bulan Lalu</span>
              </span>
